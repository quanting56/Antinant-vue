import{_ as x,r as f,k as y,o as _,p as g,c as e,b as t,i as o,g as u,F as p,d as N,w,T as k,f as s,j as m,t as r,h as v,s as j,v as F,n as T}from"./index-C1gfjxE6.js";import{H as n,x as H,j as S}from"./vs2015-CSxvYctc.js";const B={class:"bootstrap-note-view"},K={class:"layout"},U={class:"sidebar"},C=["onClick"],z={class:"content-title"},L={class:"content-body"},M=["innerHTML"],D=["innerHTML"],J={class:"code"},P={class:"html"},A={class:"javascript"},V={__name:"BootstrapNoteView",setup(W){n.registerLanguage("html",H),n.registerLanguage("javascript",S);const d=[{id:"breakPointTest",title:"斷點測試",description:null,demoStyle:null,component:null,demo:`<!-- 導覽元件 -->
