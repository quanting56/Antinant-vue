import{_ as h,r as x,k as f,o as y,p,c as e,b as t,i as o,g as _,F as g,d as u,w as N,T as w,f as s,j as k,t as r,h as v,s as j,v as F,n as T}from"./index-CRU9xyTZ.js";import{H as n,x as H,j as S}from"./vs2015-CMXDCM_s.js";const B={class:"useful-bootstrap-component-view"},K={class:"layout"},U={class:"sidebar"},C=["onClick"],z={class:"content-title"},L={class:"content-body"},M=["innerHTML"],D={class:"demo"},J=["innerHTML"],P={key:1,class:"code"},A={class:"html"},V={class:"javascript"},W={__name:"BootstrapNoteView",setup(E){n.registerLanguage("html",H),n.registerLanguage("javascript",S);const d=[{id:"breakPointTest",title:"斷點測試",description:null,demoStyle:null,component:null,demo:`<!-- 導覽元件 -->
...
</div>`,demoJS:null}],b=x(d[0].id),a=f(()=>d.find(c=>c.id===b.value)||d[0]);y(()=>{p(()=>n.highlightAll())});function m(){p(()=>{document.querySelectorAll("pre code").forEach(c=>{delete c.dataset.highlighted}),n.highlightAll()})}return(c,l)=>(s(),e("div",B,[l[3]||(l[3]=t("h3",null,[o(" 此頁面尚未完全完工，目前僅將程式碼放進，還未完全套入 Bootstrap 效果。需使用此區程式碼請至舊網頁 "),t("a",{href:"https://quanting56.github.io/Antinant/web_note.html#bootstrapNote",target:"_blank",style:{"background-color":"#f2ea9d","text-wrap":"nowrap"}},"舊・阿蛤的窩 - 網頁練習｜Bootstrap網格與內容樣式筆記"),o(" 查詢 UI/UX 與 code。 ")],-1)),t("div",K,[t("nav",U,[t("ul",null,[(s(),e(g,null,u(d,i=>t("li",{key:i.id,class:k({active:i.id===b.value}),onClick:G=>b.value=i.id},r(i.title),11,C)),64))])]),_(w,{name:"fade",mode:"out-in",onAfterEnter:m},{default:N(()=>[a.value?(s(),e("section",{class:"content",key:a.value.id},[t("h3",z,r(a.value.title),1),l[2]||(l[2]=t("hr",null,null,-1)),t("div",L,[a.value.description?(s(),e("div",{key:0,class:"description",innerHTML:a.value.description},null,8,M)):v("",!0),t("div",D,[a.value.component?(s(),j(F(a.value.component),{key:0})):(s(),e("div",{key:1,innerHTML:a.value.demo,style:T(a.value.demoStyle)},null,12,J))]),a.value.demo?(s(),e("div",P,[l[1]||(l[1]=o(" html code: ")),t("pre",null,[t("code",A,r(a.value.demo),1)]),a.value.demoJS?(s(),e(g,{key:0},[l[0]||(l[0]=o(" javascript code: ")),t("pre",null,[t("code",V,r(a.value.demoJS),1)])],64)):v("",!0)])):v("",!0)])])):v("",!0)]),_:1})])]))}},X=h(W,[["__scopeId","data-v-2bc32abe"]]);export{X as default};
