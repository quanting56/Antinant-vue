import{_ as f,r as g,k as y,o as k,p as u,c as n,b as t,g as b,F as p,d as x,w as S,T as w,f as s,j as h,t as d,h as c,s as T,v as A,n as C,i as v}from"./index-dDlPNz8Q.js";import{H as r,x as N,j as B}from"./vs2015-CMXDCM_s.js";const j={class:"css-function-note-view"},H={class:"layout"},L={class:"sidebar"},F=["onClick"],J={class:"content-title"},V={class:"content-body"},M=["innerHTML"],z=["innerHTML"],E={class:"code"},I={class:"html"},D={class:"javascript"},q={__name:"CssFunctionNoteView",setup($){r.registerLanguage("html",N),r.registerLanguage("javascript",B);const i=[{id:"bootstrapIconNote",title:"Bootstrap-icons",description:'<p>📌 <a href="https://icons.bootcss.com" target="_blank">Bootstrap官方圖標庫</a></p><p>使用範例如下：</p>',demoStyle:null,component:null,demo:`<!-- 可在 <head> 裡面增加此 <link> 以啟用 bootstrap-icons -->
