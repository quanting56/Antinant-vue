const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/D3jsSelectionEnterDemo-D72m48-Z.js","assets/transform-CCOk6-7m.js","assets/index-DKptyNhX.js","assets/index-D8FoEtp3.css","assets/D3jsSelectionExitDemo-BezpNAuQ.js","assets/D3jsSelectionJoin1Demo-CMKSHy56.js","assets/D3jsSelectionJoin2Demo-BSYdcIuA.js","assets/D3jsDataBindingPractice-Byotru6E.js","assets/D3jsDataBindingPractice-Cc-4O5tI.css"])))=>i.map(i=>d[i]);
import{m as r,q as c,_ as x,r as T,k as j,o as f,p as S,c as t,b as n,g as _,F as u,d as g,u as w,w as k,T as A,f as e,j as L,t as a,h as d,n as P,s as b,v,i as y}from"./index-DKptyNhX.js";import{H as p,x as N,j as M}from"./vs2015-CMXDCM_s.js";const O=[{id:"d3jsStartNote",title:"開始使用 D3.js",description:`<p><a href="https://d3js.org" target="_blank">D3.js 官網</a></p>
...
</svg>`,descriptionComponent:null,descriptionComponentStyle:"style='width: 800px; height: 400px;'",lists:[{listTitle:"資料綁定 API",listSubtitle:null,listComponent:null,listCode:{htmlCode:null,jsCode:null,vueCode:null},listDetails:[{detailTitle:"<code>selection.enter()</code>",detailSubtitle:"DOM 比較少的話，用 <code>enter()</code> 和 <code>append()</code> 調整。",detailComponent:r(()=>c(()=>import("./D3jsSelectionEnterDemo-D72m48-Z.js"),__vite__mapDeps([0,1,2,3]))),detailCode:{htmlCode:`<div class="d3-Enter">
  <p></p>
  <p></p>
  <p></p>
</div>
...
<\/script>`,jsCode:null,vueCode:null}},{detailTitle:"<code>selection.exit()</code>",detailSubtitle:"DOM 比較多的話，用 <code>exit()</code> 和 <code>remove()</code> 調整。",detailComponent:r(()=>c(()=>import("./D3jsSelectionExitDemo-BezpNAuQ.js"),__vite__mapDeps([4,1,2,3]))),detailCode:{htmlCode:`<div class="d3-Exit">
  <p></p>
  <p></p>
  <p></p>
  <p></p>
...
<\/script>`,jsCode:null,vueCode:null}},{detailTitle:"<code>selection.join()</code>",detailSubtitle:"用 <code>join()</code> 來調整 DOM 與 data 的數量差異。",detailComponent:r(()=>c(()=>import("./D3jsSelectionJoin1Demo-CMKSHy56.js"),__vite__mapDeps([5,1,2,3]))),detailCode:{htmlCode:`<div class="d3-Join1">
  <p></p>
  <p></p>
  <p></p>
</div>
...
<\/script>`,jsCode:null,vueCode:null}},{detailTitle:"<code>selection.join(<i>enter[, update][, exit]</i>)</code>",detailSubtitle:"用 <code>join(<i>enter, update, exit</i>)</code> 來調整 DOM 與 data 的數量差異。",detailComponent:r(()=>c(()=>import("./D3jsSelectionJoin2Demo-BSYdcIuA.js"),__vite__mapDeps([6,1,2,3]))),detailCode:{htmlCode:`<div class="d3-Join2">
  <p></p>
  <p></p>
  <p></p>
</div>
...
</ol>`,listComponent:r(()=>c(()=>import("./D3jsDataBindingPractice-Byotru6E.js"),__vite__mapDeps([7,2,3,1,8]))),listCode:{htmlCode:`<div>
  <label>資料數量</label>
...
console.log("minimum", minNumber);`,vueCode:null}},{detailTitle:"<code>d3.max()</code> 尋找最大值",detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:`const numberData = [5, 1, 35, 13, 15, 18, 21, 31, 29];
const maxNumber = d3.max(numberData);
console.log("maximum", maxNumber);`,vueCode:null}},{detailTitle:"<code>d3.extent()</code> 同時找出最小值與最大值",detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:`const numberData = [5, 1, 35, 13, 15, 18, 21, 31, 29];
const extent = d3.extent(numberData);
console.log("minimum and maximum", extent);`,vueCode:null}},{detailTitle:"<code>d3.sum()</code> 加總",detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:`const numberData = [5, 1, 35, 13, 15, 18, 21, 31, 29];
const sum = d3.sum(numberData);
console.log("sum", sum);
`,vueCode:null}},{detailTitle:"<code>d3.every(<i>資料, 方法</i>)</code> 遍歷資料陣列，確認陣列內的值是否都符合條件",detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:`const numberData = [5, 1, 35, 13, 15, 18, 21, 31, 29];
const isAllIntegerBiggerThanTwenty = d3.every(numberData, (d) => d > 20);
console.log("every > 20", isAllIntegerBiggerThanTwenty);`,vueCode:null}},{detailTitle:"<code>d3.some(<i>資料, 方法</i>)</code>遍歷資料陣列，確認陣列內的值是否至少有一項符合條件",detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:`const numberData = [5, 1, 35, 13, 15, 18, 21, 31, 29];
const isAnyIntegerBiggerThanTwenty = d3.some(numberData, (d) => d > 20);
console.log("any > 20", isAnyIntegerBiggerThanTwenty);`,vueCode:null}},{detailTitle:"<code>d3.filter(<i>資料, 方法</i>)</code>遍歷資料陣列，回傳所有符合條件的資料",detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:`const numberData = [5, 1, 35, 13, 15, 18, 21, 31, 29];
const filter = d3.filter(numberData, (d) => d > 20);
console.log("filter", filter);`,vueCode:null}},{detailTitle:"<code>d3.sort(<i>資料[, 方法]</i>)</code>整理並排序陣列中的資料，預設是由小到大排序陣列",detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:`const numberData = [5, 1, 35, 13, 15, 18, 21, 31, 29];
const sort = d3.sort(numberData);
console.log("sort", sort);
`,vueCode:null}}]},{listTitle:"Time Formats 分類的常用 API",listSubtitle:`<ul><li>
...
console.log("d3標準格式時間", timeParse);`,vueCode:null}},{detailTitle:"<code>d3.timeFormat(<i>轉換出來的方式</i>)</code> 將 d3.js 能夠看得懂的數值轉換成我們要的日期格式",detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:`// 若已有d3標準格式時間，可以直接套入以下code
...
console.log("將數值千位一個逗號", dataAdjusted);`,vueCode:null}}]},{listTitle:"Random Numbers 分類的常用 API",listSubtitle:null,listComponent:null,listCode:{htmlCode:null,jsCode:null,vueCode:null},listDetails:[{detailTitle:"<code>d3.randomInt(<i>[最小值, ]最大值</i>)</code> 產生隨機整數。若未設定最小值，最小值預設為 0。",detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:` // 沒有設定最小值
...
</table>`,descriptionComponent:null,descriptionComponentStyle:null,lists:[{listTitle:"Generators",listSubtitle:null,listComponent:null,listCode:{htmlCode:null,jsCode:null,vueCode:null},listDetails:[{detailTitle:"Lines",detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:`<svg id="lineWrapper"></svg>
...
<\/script>`,jsCode:null,vueCode:null}},{detailTitle:"Areas",detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:`<svg id="areaWrapper"></svg>
...
<\/script>`,jsCode:null,vueCode:null}},{detailTitle:"Curves",detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:`<svg id="curveWrapper"></svg>
...
<script>
  ...
  d3.select("#curveWrapper")
    ...
    .attr("stroke-width", "2")
    .attr("fill", "none");
<\/script>`,jsCode:null,vueCode:null}},{detailTitle:"Arcs",detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:`<svg id="arcWrapper"></svg>
...
<script>
  ...
  d3.select("#arcWrapper")
    ...
    .attr("stroke", "black")
    .attr("fill", "rgba(31, 211, 255, 0.2)");
<\/script>`,jsCode:null,vueCode:null}}]},{listTitle:"Components",listSubtitle:null,listComponent:null,listCode:{htmlCode:null,jsCode:null,vueCode:null},listDetails:[{detailTitle:"Axes",detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:`<svg id="axeWrapper"></svg>
...
<\/script>`,jsCode:null,vueCode:null}}]},{listTitle:"Layouts",listSubtitle:null,listComponent:null,listCode:{htmlCode:null,jsCode:null,vueCode:null},listDetails:[{detailTitle:"Stacks",detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:`<svg id="stackWrapper"></svg>
...
<script>
  ...
  g.selectAll("rect")
   ...
   .attr("y", (d, i) => i * 35)
   .attr("height", 20);
<\/script>`,jsCode:null,vueCode:null}}]}]},{id:"d3jsScalesNote",title:"各種比例尺",description:`<svg width="450" height="120">
...
`,vueCode:null}},{detailTitle:"<code>continuous.invert()</code>、<code>continuous.clamp()</code>、<code>continuous.nice()</code>一些連續比例尺的細節設定 API",detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:`// continuous.invert() 反推轉換
...
</ul>`,descriptionComponent:null,descriptionComponentStyle:null,lists:[{listTitle:null,listSubtitle:null,listComponent:null,listCode:{htmlCode:null,jsCode:null,vueCode:null},listDetails:[{detailTitle:null,detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:null,vueCode:null}}]}]},{id:"d3jsAnimationNote",title:"動畫",description:null,descriptionComponent:null,descriptionComponentStyle:null,lists:[{listTitle:null,listSubtitle:null,listComponent:null,listCode:{htmlCode:null,jsCode:null,vueCode:null},listDetails:[{detailTitle:null,detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:null,vueCode:null}}]}]},{id:"d3jsMouseEventNote",title:"滑鼠事件",description:null,descriptionComponent:null,descriptionComponentStyle:null,lists:[{listTitle:null,listSubtitle:null,listComponent:null,listCode:{htmlCode:null,jsCode:null,vueCode:null},listDetails:[{detailTitle:null,detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:null,vueCode:null}}]}]},{id:"d3jsPieChartNote",title:"圓餅圖",description:null,descriptionComponent:null,descriptionComponentStyle:null,lists:[{listTitle:null,listSubtitle:null,listComponent:null,listCode:{htmlCode:null,jsCode:null,vueCode:null},listDetails:[{detailTitle:null,detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:null,vueCode:null}}]}]},{id:"d3jsScatterChartNote",title:"散點圖",description:null,descriptionComponent:null,descriptionComponentStyle:null,lists:[{listTitle:null,listSubtitle:null,listComponent:null,listCode:{htmlCode:null,jsCode:null,vueCode:null},listDetails:[{detailTitle:null,detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:null,vueCode:null}}]}]},{id:"d3jsBubbleChartNote",title:"氣泡圖",description:null,descriptionComponent:null,descriptionComponentStyle:null,lists:[{listTitle:null,listSubtitle:null,listComponent:null,listCode:{htmlCode:null,jsCode:null,vueCode:null},listDetails:[{detailTitle:null,detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:null,vueCode:null}}]}]},{id:"d3jsBarChartNote",title:"長條圖",description:null,descriptionComponent:null,descriptionComponentStyle:null,lists:[{listTitle:null,listSubtitle:null,listComponent:null,listCode:{htmlCode:null,jsCode:null,vueCode:null},listDetails:[{detailTitle:null,detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:null,vueCode:null}}]}]},{id:"d3jsLineChartNote",title:"折線圖",description:null,descriptionComponent:null,descriptionComponentStyle:null,lists:[{listTitle:null,listSubtitle:null,listComponent:null,listCode:{htmlCode:null,jsCode:null,vueCode:null},listDetails:[{detailTitle:null,detailSubtitle:null,detailComponent:null,detailCode:{htmlCode:null,jsCode:null,vueCode:null}}]}]}],I={class:"d3js-note-view"},F={class:"layout"},E={class:"sidebar"},q=["onClick"],z={class:"content-title"},H=["innerHTML"],R={key:2,class:"content-body"},J=["innerHTML"],W=["innerHTML"],B={key:1,class:"lists-demo"},V={key:2,class:"code"},U={key:0},G={class:"html"},Q={key:1},Y={class:"javascript"},X={class:"html"},$={key:3},K=["innerHTML"],Z=["innerHTML"],ee={key:1,class:"details-demo"},te={key:2,class:"code"},le={key:0},de={class:"html"},oe={key:1},ne={class:"javascript"},ie={class:"html"},ae={__name:"D3jsNoteView",setup(se){const m=O,h=T(m[4].id),i=j(()=>m.find(C=>C.id===h.value)||m[0]);p.registerLanguage("html",N),p.registerLanguage("javascript",M),f(()=>{S(()=>p.highlightAll())});function D(){S(()=>{document.querySelectorAll("pre code").forEach(C=>{delete C.dataset.highlighted}),p.highlightAll()})}return(C,s)=>(e(),t("div",I,[n("div",F,[n("nav",E,[n("ul",null,[(e(!0),t(u,null,g(w(m),l=>(e(),t("li",{key:l.id,class:L({active:l.id===h.value}),onClick:o=>h.value=l.id},a(l.title),11,q))),128))])]),_(A,{name:"fade",mode:"out-in",onAfterEnter:D},{default:k(()=>[i.value?(e(),t("section",{class:"content",key:i.value.id},[n("h3",z,a(i.value.title),1),s[2]||(s[2]=n("hr",null,null,-1)),i.value.description?(e(),t("div",{key:0,class:"description",innerHTML:i.value.description},null,8,H)):d("",!0),i.value.descriptionComponent?(e(),t("div",{key:1,style:P(i.value.descriptionComponentStyle),class:"description-component"},[(e(),b(v(i.value.descriptionComponent)))],4)):d("",!0),i.value.lists.length&&i.value.lists[0].listTitle?(e(),t("ul",R,[(e(!0),t(u,null,g(i.value.lists,l=>(e(),t("li",{key:l.listTitle,class:"list"},[n("h4",{class:"list-title",innerHTML:l.listTitle},null,8,J),l.listSubtitle?(e(),t("div",{key:0,class:"list-subtitle",innerHTML:l.listSubtitle},null,8,W)):d("",!0),l.listComponent?(e(),t("div",B,[(e(),b(v(l.listComponent)))])):d("",!0),l.listCode.htmlCode||l.listCode.jsCode||l.listCode.vueCode?(e(),t("div",V,[l.listCode.htmlCode?(e(),t("pre",U,[n("code",G,a(l.listCode.htmlCode),1)])):d("",!0),l.listCode.jsCode?(e(),t("pre",Q,[n("code",Y,a(l.listCode.jsCode),1)])):d("",!0),l.listCode.vueCode?(e(),t(u,{key:2},[s[0]||(s[0]=y(" Vue SFC 這樣寫（Vue 3 - Composition API）： ")),n("pre",null,[n("code",X,a(l.listCode.vueCode),1)])],64)):d("",!0)])):d("",!0),l.listDetails.length&&l.listDetails[0].detailTitle?(e(),t("ol",$,[(e(!0),t(u,null,g(l.listDetails,o=>(e(),t("li",{key:o.detailTitle,class:"detail"},[n("h5",{class:"detail-title",innerHTML:o.detailTitle},null,8,K),o.detailSubtitle?(e(),t("div",{key:0,class:"detail-subtitle",innerHTML:o.detailSubtitle},null,8,Z)):d("",!0),o.detailComponent?(e(),t("div",ee,[(e(),b(v(o.detailComponent)))])):d("",!0),o.detailCode.htmlCode||o.detailCode.jsCode||o.detailCode.vueCode?(e(),t("div",te,[o.detailCode.htmlCode?(e(),t("pre",le,[n("code",de,a(o.detailCode.htmlCode),1)])):d("",!0),o.detailCode.jsCode?(e(),t("pre",oe,[n("code",ne,a(o.detailCode.jsCode),1)])):d("",!0),o.detailCode.vueCode?(e(),t(u,{key:2},[s[1]||(s[1]=y(" Vue SFC 這樣寫（Vue 3 - Composition API）： ")),n("pre",null,[n("code",ie,a(o.detailCode.vueCode),1)])],64)):d("",!0)])):d("",!0)]))),128))])):d("",!0)]))),128))])):d("",!0)])):d("",!0)]),_:1})])]))}},ue=x(ae,[["__scopeId","data-v-831dbfca"]]);export{ue as default};
