const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/JsOpenCloseWindowNoteDemo-CDtari7a.js","assets/index-Dky9J6f4.js","assets/index-DRe3yBbq.css","assets/JsOpenCloseWindowNoteDemo-TSkHhGjF.css","assets/ButtomUpdateMessageNoteDemo-BWejbCev.js","assets/ButtomUpdateMessageNoteDemo-tKWPik4T.css"])))=>i.map(i=>d[i]);
import{_ as w,r as D,m as p,k as f,o as k,p as v,c as n,b as t,g as T,F as m,d as b,w as M,T as S,q as _,f as o,j as h,t as d,h as c,s as L,v as Q,n as j,i as g}from"./index-Dky9J6f4.js";import{H as r,x,j as A}from"./vs2015-CMXDCM_s.js";const C={class:"javascript-note-view"},H={class:"layout"},J={class:"sidebar"},E=["onClick"],N={class:"content-title"},V={class:"content-body"},B=["innerHTML"],W=["innerHTML"],O={class:"code"},I={class:"html"},P={class:"javascript"},R={__name:"JavascriptNoteView",setup(U){r.registerLanguage("html",x),r.registerLanguage("javascript",A);const a=[{id:"jsOpenCloseWindowNote",title:"開新視窗與關閉視窗",description:null,demoStyle:null,component:p(()=>_(()=>import("./JsOpenCloseWindowNoteDemo-CDtari7a.js"),__vite__mapDeps([0,1,2,3]))),demo:`<!-- 這裡使用 Bootstrap 的樣式 -->
...
};`},{id:"bottomUpdateMessageNote",title:"按鈕更新文字",description:"<p>註：此處是用傳統 JavaScript 寫的 DOM 操作，若在 Vue.js 中，可以改透過 <code>v-text</code> 、 <code>{{ message }}</code> 或 <code>v-html</code> 等「響應式資料綁定」來實現畫面更新。</p>",demoStyle:null,component:p(()=>_(()=>import("./ButtomUpdateMessageNoteDemo-BWejbCev.js"),__vite__mapDeps([4,1,2,5]))),demo:`<div id="msg">原始文字</div>
