const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/JsOpenCloseWindowNoteDemo-SyEIDPd5.js","assets/index-CzRUwQiI.js","assets/index-CtERxmw5.css","assets/JsOpenCloseWindowNoteDemo-TSkHhGjF.css","assets/ButtomUpdateMessageNoteDemo-YGN2g1io.js","assets/ButtomUpdateMessageNoteDemo-tKWPik4T.css"])))=>i.map(i=>d[i]);
import{_ as w,r as S,m as p,k as D,o as f,p as g,c as n,b as t,g as k,F as m,d as H,w as T,T as b,q as v,f as o,j as h,t as c,h as d,s as M,v as x,n as A,i as _}from"./index-CzRUwQiI.js";import{H as r}from"./vs2015-txMzNINg.js";import{x as L,j as N}from"./javascript-BK9ByurK.js";const C={class:"javascript-note-view"},J={class:"layout"},Q={class:"sidebar"},j=["onClick"],E={class:"content-title"},I={class:"content-body"},V=["innerHTML"],B=["innerHTML"],P={class:"code"},W={class:"html"},O={class:"javascript"},K={__name:"JavascriptNoteView",setup(R){r.registerLanguage("html",L),r.registerLanguage("javascript",N);const a=[{id:"jsOpenCloseWindowNote",title:"開新視窗與關閉視窗",description:null,demoStyle:null,component:p(()=>v(()=>import("./JsOpenCloseWindowNoteDemo-SyEIDPd5.js"),__vite__mapDeps([0,1,2,3]))),demo:`<!-- 這裡使用 Bootstrap 的樣式 -->
...
};`},{id:"bottomUpdateMessageNote",title:"按鈕更新文字",description:"<p>註：此處是用傳統 JavaScript 寫的 DOM 操作，若在 Vue.js 中，可以改透過 <code>v-text</code> 、 <code>{{ message }}</code> 或 <code>v-html</code> 等「響應式資料綁定」來實現畫面更新。</p>",demoStyle:null,component:p(()=>v(()=>import("./ButtomUpdateMessageNoteDemo-YGN2g1io.js"),__vite__mapDeps([4,1,2,5]))),demo:`<div id="msg">原始文字</div>
