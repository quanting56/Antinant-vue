const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/DropDownHrefNoteDemo-Dlw_5ijh.js","assets/index-DFuPimHW.js","assets/index-DRe3yBbq.css","assets/ImageHoverSwitchNoteDemo-D-e9vDN5.js","assets/ImageOverlayTransitionNoteDemo-CwbV-9hH.js","assets/ImageOverlayTransitionNoteDemo-jat9u6hS.css"])))=>i.map(i=>d[i]);
import{_ as f,r as x,m,k as _,o as w,p as h,c as l,b as t,g as S,F as u,d as k,w as I,T,q as g,f as o,j as y,t as d,h as r,s as J,v as L,n as E,i as v}from"./index-DFuPimHW.js";import{H as p,x as H,j as C}from"./vs2015-CMXDCM_s.js";const V={class:"webnote-simple-view"},B={class:"layout"},j={class:"sidebar"},M=["onClick"],P={class:"content-title"},A={class:"content-body"},F=["innerHTML"],N=["innerHTML"],D={class:"code"},G={class:"html"},Y={class:"javascript"},$={__name:"WebNoteSimpleView",setup(z){p.registerLanguage("html",H),p.registerLanguage("javascript",C);const a=[{id:"noteSpacing",title:"字的間距",description:"<p>字間距測試</p>",demoStyle:null,component:null,demo:`<ul class="spacing-test">
...
</div>`,demoJS:null},{id:"noteDropDownHref",title:"下拉式超連結",description:"<p>透過超連結下拉式清單到新網頁</p>",demoStyle:null,component:m(()=>g(()=>import("./DropDownHrefNoteDemo-Dlw_5ijh.js"),__vite__mapDeps([0,1,2]))),demo:`<select id="searchEngine">
...
};`},{id:"noteMoveToChangeImg",title:"移動游標換照片",description:"<p>移動游標改變顯示圖標（JavaScript／jQuery）</p>",demoStyle:null,component:m(()=>g(()=>import("./ImageHoverSwitchNoteDemo-D-e9vDN5.js"),__vite__mapDeps([3,1,2]))),demo:`<!-- 純 JavaScript 的 html code 用這個 -->
...
});`},{id:"notePictureChange",title:"疊圖照片接替出現",description:null,demoStyle:null,component:m(()=>g(()=>import("./ImageOverlayTransitionNoteDemo-CwbV-9hH.js"),__vite__mapDeps([4,1,2,5]))),demo:`<!-- 本段以 Vue SFC 寫成，並未使用純 HTML -->
<!-- 請至以下 SFC 檔查看 code -->
