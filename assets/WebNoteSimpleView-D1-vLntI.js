const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/DropDownHrefNoteDemo-BpKzPICD.js","assets/index-B1OBybhT.js","assets/index-CtERxmw5.css","assets/ImageHoverSwitchNoteDemo-BMXce2UJ.js","assets/ImageOverlayTransitionNoteDemo-DH0-OpXf.js","assets/ImageOverlayTransitionNoteDemo-jat9u6hS.css"])))=>i.map(i=>d[i]);
import{_ as f,r as x,m,k as _,o as w,p as h,c as i,b as t,g as S,F as u,d as k,w as I,T,q as g,f as o,j as y,t as d,h as r,s as J,v as L,n as E,i as v}from"./index-B1OBybhT.js";import{H as p}from"./vs2015-txMzNINg.js";import{x as H,j as C}from"./javascript-BK9ByurK.js";const V={class:"webnote-simple-view"},B={class:"layout"},j={class:"sidebar"},M=["onClick"],P={class:"content-title"},A={class:"content-body"},F=["innerHTML"],N=["innerHTML"],D={class:"code"},G={class:"html"},Y={class:"javascript"},$={__name:"WebNoteSimpleView",setup(z){p.registerLanguage("html",H),p.registerLanguage("javascript",C);const a=[{id:"noteSpacing",title:"字的間距",description:"<p>字間距測試</p>",demoStyle:null,component:null,demo:`<ul class="spacing-test">
...
</ul>`,demoJS:null},{id:"noteTextShadow",title:"文字陰影",description:"<p>文字陰影測試（text-shadow）</p>",demoStyle:"font-size: 24px;",component:null,demo:`<p style="text-shadow: 3px 3px 3px gray;">文字測試一</p>
...
</div>`,demoJS:null},{id:"noteDropDownHref",title:"下拉式超連結",description:"<p>透過超連結下拉式清單到新網頁</p>",demoStyle:null,component:m(()=>g(()=>import("./DropDownHrefNoteDemo-BpKzPICD.js"),__vite__mapDeps([0,1,2]))),demo:`<select id="searchEngine">
...
};`},{id:"noteMoveToChangeImg",title:"移動游標換照片",description:"<p>移動游標改變顯示圖標（JavaScript／jQuery）</p>",demoStyle:null,component:m(()=>g(()=>import("./ImageHoverSwitchNoteDemo-BMXce2UJ.js"),__vite__mapDeps([3,1,2]))),demo:`<!-- 純 JavaScript 的 html code 用這個 -->
...
});`},{id:"notePictureChange",title:"疊圖照片接替出現",description:null,demoStyle:null,component:m(()=>g(()=>import("./ImageOverlayTransitionNoteDemo-DH0-OpXf.js"),__vite__mapDeps([4,1,2,5]))),demo:`<!-- 本段以 Vue SFC 寫成，並未使用純 HTML -->
<!-- 請至以下 SFC 檔查看 code -->
...
</ol>`,demoJS:null}],c=x(a[0].id),e=_(()=>a.find(s=>s.id===c.value)||a[0]);w(()=>{h(()=>p.highlightAll())});function b(){h(()=>{document.querySelectorAll("pre code").forEach(s=>{delete s.dataset.highlighted}),p.highlightAll()})}return(s,l)=>(o(),i("div",V,[t("div",B,[t("nav",j,[t("ul",null,[(o(),i(u,null,k(a,n=>t("li",{key:n.id,class:y({active:n.id===c.value}),onClick:O=>c.value=n.id},d(n.title),11,M)),64))])]),S(T,{name:"fade",mode:"out-in",onAfterEnter:b},{default:I(()=>[e.value?(o(),i("section",{class:"content",key:e.value.id},[t("h3",P,d(e.value.title),1),l[2]||(l[2]=t("hr",null,null,-1)),t("div",A,[e.value.description?(o(),i("div",{key:0,class:"description",innerHTML:e.value.description},null,8,F)):r("",!0),t("div",{class:y({demo:e.value.demo})},[e.value.component?(o(),J(L(e.value.component),{key:0})):(o(),i("div",{key:1,innerHTML:e.value.demo,style:E(e.value.demoStyle)},null,12,N))],2),t("div",D,[e.value.demo?(o(),i(u,{key:0},[l[0]||(l[0]=v(" html code: ")),t("pre",null,[t("code",G,d(e.value.demo),1)])],64)):r("",!0),e.value.demoJS?(o(),i(u,{key:1},[l[1]||(l[1]=v(" javascript code: ")),t("pre",null,[t("code",Y,d(e.value.demoJS),1)])],64)):r("",!0)])])])):r("",!0)]),_:1})])]))}},R=f($,[["__scopeId","data-v-0db48e14"]]);export{R as default};
