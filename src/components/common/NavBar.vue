...
const navItems = ref([
  ...
  },
  {
    ...
    open: false,
    children: [
      { label: '試驗場', href: 'web_note/TestTestTest.html', target: '_blank' },
      { divider: true },
      { header: '非Bootsrap相關筆記' },
      { label: '網頁練習筆記區', href: 'web_note.html#webNote' },
      { divider: true },
      { header: 'Bootstrap相關筆記' },
      { label: '一些好用的Bootstrap元件', href: 'web_note.html#usefulBootstrapComponent' },
