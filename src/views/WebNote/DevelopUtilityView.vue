<template>
  <div class="develop-utility-view">
            ...
            >
              ...
              <ol v-if="list.listDetails.length && list.listDetails[0].detailTitle">
                ...
                >
                  ...
                  ></div>
                  <div v-if="detail.detailComponent" class="details-utility">
...
const tabs = [
  {
    id: "colorPalettePreview",
    title: "色碼查詢",
    description: null,
    descriptionComponent: defineAsyncComponent(() =>
      import("../../components/WebNoteView/DevelopUtilityView/ColorPalettePreview.vue")
    ),
