  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img src="${cimeiTheTiger2019}" title="2019_cimei_thetiger.jpg" alt="2019在七美的阿楷" width="50%" class="img-fluid">
...
<div id="CardTabContent" class="tab-content">
  ...
  <div id="tabCard2" class="tab-pane fade mt-3">
    ...
    <div class="card" style="width: 20rem;">
      <img src="${dsc4378}" title="搧風亭儀" alt="天氣熱，何亭儀在搧風" class="card-img-top" width="318px">
      <div class="card-body">
      ...
      <div class="row">
        <div class="col-sm-6 mt-3">
          <div class="card">
            ...
            <img class="card-img-top" src="${taiAnBedroom2023}" title="拍照的旻倫" alt="2023年跨年烤肉在拍照的旻倫" width="300px">
            <div class="card-body">
        ...
        <div class="col-sm-6 mt-3">
          <div class="card">
            ...
            <img class="card-img-top" src="${taiAnTheTiger2023}" title="拍照的竣楷" alt="2023年跨年烤肉在拍照的阿楷" width="300px">
            <div class="card-body">
...
`<div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="${erlin012021}" class="d-block w-100" alt="二林臺灣酒窖" style="width: 100%;">
      <div class="carousel-caption d-none d-md-block">
        <h5>臺灣酒窖</h5>
      </div>
    </div>
    <div class="carousel-item">
      <img src="${dsc5360}" class="d-block w-100" alt="芳苑夕景與離岸風電" style="width: 100%;">
      <div class="carousel-caption d-none d-md-block">
        <h5>芳苑夕陽與離岸風電</h5>
      </div>
    </div>
    <div class="carousel-item">
      <img src="${dsc5434}" class="d-block w-100" alt="芳苑夕景剪影" style="width: 100%;">
      <div class="carousel-caption d-none d-md-block">
        <h5>芳苑夕景</h5>
      </div>
    </div>
